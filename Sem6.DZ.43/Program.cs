...
if (ValidateLines(lineData1, lineData2))
{
    ...
    Console.Write($"Точка пересечения уравнени y={lineData1 [COEFFICIENT]}*x+{lineData1[CONSTANT]} и y={lineData2 [COEFFICIENT]}*x+{lineData2[CONSTANT]} ");
...
double[] InputLineData( int numberOfLine)
{
    ...
    lineData[CONSTANT] = Prompt($"Введите константу для {numberOfLine} прямой Ю");
    return lineData;
}
